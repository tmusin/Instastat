...
const val API_PROFILE_HISTORY_POSTS_PARAMETER = "$API_PROFILE_HISTORY_POSTS/{profileName}"
const val API_PROFILE_HISTORY_FOLLOWERS = "$API_PATH/history/followers"
const val API_PROFILE_HISTORY_FOLLOWERS_PARAMETER = "$API_PROFILE_HISTORY_FOLLOWERS/{profileName}"
const val API_PROFILE_HISTORY_FOLLOWINGS = "$API_PATH/history/followings"
const val API_PROFILE_HISTORY_FOLLOWINGS_PARAMETER = "$API_PROFILE_HISTORY_FOLLOWINGS/{profileName}"
