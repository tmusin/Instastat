...
import ru.musintimur.instastat.common.constants.ADD_POST_MESSAGE
import ru.musintimur.instastat.common.constants.API_ADD_POST
...
fun onPostSubmit(form: HTMLFormElement) {
    val messageBlock = document.getElementById(ADD_POST_MESSAGE)
    val data = form.collectParameters()

    val request = XMLHttpRequest()
    request.setupPost(API_ADD_POST) {
        runCatching {
